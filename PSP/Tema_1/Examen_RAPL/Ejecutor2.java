...
public class Ejecutor2 {
    public static void main(String[] args) {
		...
		try {
            ...
            File pfile = new File("numeros.txt");
			...
			pbGenerador.command("java", "Generador", "|", "numeros.txt");
			...
			Scanner scGenerador = new Scanner(new File("numeros.txt")); // ??
            PrintWriter fl = new PrintWriter(pfile);
			...
			while (scGenerador.hasNextInt()) {
                ...
                System.out.println(numeroGenerador);
				fl.println(scGenerador.nextInt());
				nNumerosRecibidos++;
